...
$('clearance').addEventListener('input', renderResults);
...
$('example').addEventListener('click', () => { items=example(); boxes=PRESETS.map(p=>({...p})); $('clearance').value=0; activeBox='20DC'; activeLoad=0; pinnedBox=false; selectedKey=null; renderItems();renderBoxes();renderResults(); });
